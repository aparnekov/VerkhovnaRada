...
public class DeputyHandler {
    ...
    private List <List<Deputy>> secondList = new ArrayList<>();
            ...
            case 1:
                ...
                for (Deputy o : fractionMembers.getSapmopomich()) {
                    if (o.getBribeTaker() == false) {
                        ...
                        System.out.println("Хабарник був видалений з фракції:   " + o);
                    }
                }
                System.out.println(fractionMembers.getSapmopomich().toString());  // перевірка, скільки депутатів залишилось.
                    break;
                    case 2:
                        fractionMembers.getBlokPoroshenko().sort(comparator);
                        for (Deputy o : fractionMembers.getBlokPoroshenko()) {
